...
- Trained the robot to walk on flat terrain using the *Proximal Policy Optimization* (*PPO*) algorithm in Isaac Lab. Input data included IMU (Inertial Measurement Unit) and six joint position sensors. The robot achieved a walking speed of 20.0 cm/s on flat surfaces.
